...
<div class="container mt-3">
    <div class="d-flex align-item-center justify-content-between mb-3 ">
        <div class="col-6">
            <button type="button" class="btn btn-primary" onclick="addFormData(event)">Add Developer</button>
        </div>
        <div class="col-6">
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <div class="btn-group">
                            ...
                            <a href="{{ route('developer_delete', ['id'=>$item->id]) }}" title="DELETE" class="btn btn-danger btn-sm m-1"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
                        </div>
                    </td>
                </tr>
                @endforeach
                                    ...
                                    <div class="modal-header">
                                        ...
                                        <div class="modal-body">
                                            <form class="" id="formData" onsubmit="return postItem(event)">
                                                <input type="hidden" name="developer_reg_id" value="${obj.id}">
                                                <div class="form-group mb-3 col-sm-12  col-md-12  col-lg-12 col-xl-12 col-xxl-12">
                                                    <label for="">Developer Name</label>
                                                    <input type="text" name="developer_name" value="${obj.developer_name}" class="form-control" required>
                                                    <span class="text-danger" id="developer_name"></span>
                                                </div>
