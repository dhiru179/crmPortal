...
<nav class="bg-info d-flex justify-content-between border border-dark" aria-label="breadcrumb">
    <ol class="breadcrumb  m-0  d-flex align-items-center px-3 h4" style="height:51px;font-size:21px;">
        <li class="breadcrumb-item">Loan Facility</li>
    </ol>
...
<div class="container mt-3">
    <div class="d-flex align-item-center justify-content-between mb-3 ">
        <div class="col-6">
            <button type="button" class="btn btn-primary" onclick="addFormData(event)">Add Loan Facility</button>
        </div>
        <div class="col-6">
    ...
    <div class="table-responsive" id="appendtable">
        <table class="table table-hover table-bordered mb-5">
            ...
            <tbody id="tbody">
                @foreach($facilitator_reg as $key=>$item)<tr>
                    <td>{{$key+1}}</td>
                            ...
                            <div class="modal-dialog  modal-dialog-scrollable">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <input type="hidden" name="facilitator_reg_id" value="${obj.id}" required>
                                            <div class="form-group mb-3">
                                                <label for="">Facilitator Name</label>
                                                <input type="text" name="facilitator_name" value="${obj.facilitator_name}" class="form-control" required>
                                                <span class="text-danger" id="facilitator_name"></span>
                                            </div>
