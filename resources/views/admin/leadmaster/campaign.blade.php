                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <div class="btn-group">
                                ...
                                <button onclick="editFormData(event,'{{json_encode($item)}}')" type="button" title="DELETE" class="btn btn-danger btn-sm m-1"><i class="fa fa-trash-o" aria-hidden="true"></i></button>
                            </div>
                        </td>
                    </tr>
                    @endforeach
